...
<head>
    ...
    <link href="{{ mix('assets/admin/css/plugins.css') }}" rel="stylesheet" type="text/css"/>
    <link class="main-stylesheet" href="{{ mix('assets/admin/css/template.css') }}" rel="stylesheet" type="text/css"/>

(function ($) {
    ...
    Pages.prototype.initFormGroupDefault = function (context) {
        $('.form-group.form-group-default', context).click(function () {
            if ($(this).children().hasClass('input-group')) {
                return false;
            }
    ...
    Pages.prototype.initTooltipPlugin = function (context) {
        $.fn.tooltip && $('[data-toggle="tooltip"], [data-init-plugin="tooltip"]', context).tooltip();
    }
...
(function (window) {
    ...
    SelectFx.prototype._init = function () {
        ...
        this.selectedOpt = this.el.querySelector('option[selected]') || selectedOpt;
